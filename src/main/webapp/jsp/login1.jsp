...
<section id="login">        <!--/#partner-->
         <form:form id="loginForm" modelAttribute="login"  action="/SpringMvcUser/loginProcess" method="POST">
                <table align="center">
                    <tr>
                        <td>
            ...
            <table align="center">
                ...
                <div class="col-sm-offset-2 col-sm-10">
                   <a href="register"> <button class="btn btn-link"  style="font-size: 26px; font-family: Georgia; font-weight: bold;">Sign Up Here</button></a>
                </div>
            </div></td>
                </tr>
            </table>
